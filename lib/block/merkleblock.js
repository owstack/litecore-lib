...
MerkleBlock.prototype.validMerkleTree = function validMerkleTree() {
  $.checkState(lodash.isArray(this.flags), 'MerkleBlock flags is not an array');
  $.checkState(lodash.isArray(this.hashes), 'MerkleBlock hashes is not an array');
...
MerkleBlock.prototype.hasTransaction = function hasTransaction(tx) {
  $.checkArgument(!lodash.isUndefined(tx), 'tx cannot be undefined');
