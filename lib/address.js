 ...
 * @param {Network|String|number=} network - The network: One of the supported networks
...
/**
 * Internal function to transform a litecoin address buffer
 *
 * @param {Buffer} buffer - An instance of a hex encoded address Buffer
 ...
 *
 * The addresses will be sorted lexicographically, as that is the trend in litecoin.
...
/**
 * Internal function to transform a litecoin address string
 *
 * @param {string} data
 * @param {String|Network=} network - either a Network instance or string name
 * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
...
Address.fromPrivateKey = function(data, network) {
  ...
  network = network || Networks.defaultNetwork.symbol;
 ...
 * @param {String|Network} network - either a Network instance or one of the supported networks
 * @param {string} type - The type of address: 'script' or 'pubkey'
 ...
 * @example
 * ```javascript
 * assert(Address.isValid('15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a2', 'LTC'));
 * ```
 *
 * @param {string} data - The encoded data
 * @param {String|Network} network - either a Network instance or string name
