 ...
 * @example
 * ```javascript
 * var lits = Unit.fromLTC(1.3).toLitoshis();
 * var mili = Unit.fromPhotons(1.3).to(Unit.mLTC);
...
LtcUnit.fromLTC = LtcUnit.fromStandardUnit = function(amount) {
...
LtcUnit.fromLitoshis = LtcUnit.fromAtomicUnit = function(amount) {
