 ...
 * LTC, mLTC, bits (also named uLTC) and satoshis. A unit instance can be created with an
 ...
 * @example
 * ```javascript
 * var sats = Unit.fromLTC(1.3).toSatoshis();
 * var mili = Unit.fromBits(1.3).to(Unit.mLTC);
 * var bits = Unit.fromFiat(1.3, 350).bits;
 * var ltc = new Unit(1.3, Unit.bits).LTC;
 * ```
 *
