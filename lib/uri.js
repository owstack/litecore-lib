...
/**
 * Internal function to transform a LTC string amount into satoshis
 *
 * @param {string} amount - Amount LTC string
 * @throws {TypeError} Invalid amount
...
URI.prototype._parseAmount = function(amount) {
  ...
  return Unit.fromLTC(amount).toSatoshis();
};
...
URI.prototype.toString = function() {
  var query = {};
  if (this.amount) {
    query.amount = Unit.fromSatoshis(this.amount).toLTC();
  }
  if (this.message) {
