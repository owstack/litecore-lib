...
Input.prototype._fromObject = function(params) {
  var prevTxId;
  if (lodash.isString(params.prevTxId) && JSUtil.isHexa(params.prevTxId)) {
...
Input.prototype.getLitoshisBuffer = function() {
  $.checkState(this.output instanceof Output);
  $.checkState(this.output._litoshisBN);
  return new BufferWriter().writeUInt64LEBN(this.output._litoshisBN).toBuffer();
};
