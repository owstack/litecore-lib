...
describe('BufferReader', function() {
  ...
  describe('#readUInt64LEBN', function() {
    ...
    it('should return 10LTC', function() {
      var tenltc = 10 * 1e8;
      var tenltcBuffer = new Buffer('00ca9a3b00000000', 'hex');
      var br = new BufferReader(tenltcBuffer);
      br.readUInt64LEBN().toNumber().should.equal(tenltc);
    });
